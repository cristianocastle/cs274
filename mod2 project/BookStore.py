...
class BookStore:
    ...
    def addToCatalog(self, i, book : Book.Book):
        ...
        try:
            ...
            self.bookCatalog.insert(i, book)
    ...
    def removeFromCatalog(self, i: int):
        ...
        try:
            ...
            removed_book = self.bookCatalog.pop(i)
    ...
    def searchBookByInfix(self, infix: str, k: int):
        ...
        try:
            ...
            for i in range(n):
                if infix in self.bookCatalog[i].title:
    ...
    def addBookByIndex(self, i: int):
        ...
        try:
            ...
            s = self.bookCatalog[i]

            self.shoppingCart.append(s)
    ...
    def removeFromShoppingCart(self):
        ...
        try:
            ...
            if self.shoppingCart.size() > 0:
                ...
                removed_book = self.shoppingCart.pop(0)
